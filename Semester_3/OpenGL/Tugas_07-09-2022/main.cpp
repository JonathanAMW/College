...
void drawPolygonRectangle(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4){
  glBegin(GL_POLYGON);
  glColor3f(1, 0, 0); glVertex2f(x1, y1); //merah
  glColor3f(1, 1, 0); glVertex2f(x2, y2); //kuning
  glColor3f(0, 0, 1); glVertex2f(x3, y3); //biru
  glColor3f(0, 1, 0); glVertex2f(x4, y4); //hijau
  glEnd();
}
